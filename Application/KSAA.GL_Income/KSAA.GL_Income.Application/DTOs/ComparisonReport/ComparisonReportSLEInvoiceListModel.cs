...
{
    public class ComparisonReportSLEInvoiceListModel
    {
        public List<ComparisonReportSLEInvoiceListModel> ComparSLInvoiceList { get; set; }
        public long Comparison_Report_E_Invoice_Portal_ID { get; set; }
        public string? E_Invoice_Bill_No { get; set; }
        public string E_invoice_Bill_Date { get; set; }
