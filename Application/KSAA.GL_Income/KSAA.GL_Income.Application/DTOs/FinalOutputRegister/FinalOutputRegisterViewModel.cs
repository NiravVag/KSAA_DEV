...
namespace KSAA.GL_Income.Application.DTOs.FinalOutputRegister
{
    public class FinalOutputRegisterViewModel
    {
        ...
        public string? TypeOfSupplySL { get; set; }
        public string? GSTPaymentTypeSL { get; set; }
    }
}
